// VoreBaseCallbacks is where the base callbacks (common to all templates) are stored
VoreBaseCallbacks = function ()
{
	...
	return {
		addCallbacks: function () {
			VoreStateManager.addBeforeUpdateCallbacks(_baseBeforeUpdateCallbacks);
			VoreStateManager.addAfterUpdateCallbacks(_baseAfterUpdateCallbacks);
		},
		removeCallbacks: function () {
			for (var callbackKey in _baseBeforeUpdateCallbacks)
			{
				...
				{
					VoreStateManager.removeBeforeUpdateCallback(callbackKey);
				}
			}
            for (var callbackKey in _baseAfterUpdateCallbacks)
            {
                ...
                {
                    VoreStateManager.removeAfterUpdateCallback(callbackKey);
                }
            }
        }
	};
