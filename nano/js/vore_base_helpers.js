// VoreBaseHelpers is where the base template helpers (common to all templates) are stored
VoreBaseHelpers = function ()
{
	var _baseHelpers = {
			...
			link: function( text, icon, parameters, status, elementClass, elementId) {
				...
				return '<div unselectable="on" class="link linkActive ' + iconClass + ' ' + elementClass + '" data-href="' + VoreUtility.generateHref(parameters) + '" ' + elementIdHtml + '>' + iconHtml + text + '</div>';
			},
			...
			displayDNABlocks: function(dnaString, selectedBlock, selectedSubblock, blockSize, paramKey) {
                ...
                for (index in characters)
                {
                    ...
                    html += '<div class="link ' + status + ' dnaSubBlock" data-href="' + VoreUtility.generateHref(parameters) + '" id="dnaBlock' + index + '">' + characters[index] + '</div>'
	...
	return {
        addHelpers: function ()
		{
            VoreTemplate.addHelpers(_baseHelpers);
        },
		removeHelpers: function ()
		{
			for (var helperKey in _baseHelpers)
			{
				...
				{
					VoreTemplate.removeHelper(helperKey);
				}
			}            
        }
	};
